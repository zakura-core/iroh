...
- *(iroh)* [**breaking**] Replace Incoming::local_ip with Incoming::local_addr ([#4182](https://github.com/n0-computer/iroh/issues/4182)) - ([5dc7160](https://github.com/n0-computer/iroh/commit/5dc71602e6875444bec3db16641f3528ceb58638))
- *(iroh)* [**breaking**] Update QNT config defaults & update to latest noq main ([#4213](https://github.com/n0-computer/iroh/issues/4213)) - ([00f961b](https://github.com/n0-computer/iroh/commit/00f961bb00f14775feb2907c8712ca107c1c3684))
- *(iroh, iroh-relay)* [**breaking**] Support setting auth tokens for relays ([#4205](https://github.com/n0-computer/iroh/issues/4205)) - ([1dc6fe8](https://github.com/n0-computer/iroh/commit/1dc6fe837af1f8e0bd2360a7330632ddd2f7a0d0))
- *(iroh-base)* Impl From<&[u8; 32]> for SecretKey ([#4181](https://github.com/n0-computer/iroh/issues/4181)) - ([80dfb19](https://github.com/n0-computer/iroh/commit/80dfb1938371a3a3679b1dbcd7080e3773b4c74e))
- *(iroh-relay)* [**breaking**] Pass a ClientRequest to AccessConfig and let the client set query params ([#4207](https://github.com/n0-computer/iroh/issues/4207)) - ([7bee17b](https://github.com/n0-computer/iroh/commit/7bee17b4fb4a4d0d1feb9a1116749ef2393a1ae4))
- *(metrics)* Add cache metrics to dns-server ([#3800](https://github.com/n0-computer/iroh/issues/3800)) - ([eb67669](https://github.com/n0-computer/iroh/commit/eb67669ea64038d5230087d0156974a297d35e27))
- [**breaking**] Update to 1.0.0-rc.0 deps ([#4237](https://github.com/n0-computer/iroh/issues/4237)) - ([20350e9](https://github.com/n0-computer/iroh/commit/20350e9bf6f3dea8da37aa148d79a1d77bd3c856))

### 🐛 Bug Fixes

- *(iroh)* Don't abort connection attempts when an empty `EndpointAddr` is added concurrently ([#4177](https://github.com/n0-computer/iroh/issues/4177)) - ([a1fa579](https://github.com/n0-computer/iroh/commit/a1fa579039145de344f530848b01fda27aff0288))
- *(iroh)* [**breaking**] Remove noq Written reexport ([#4236](https://github.com/n0-computer/iroh/issues/4236)) - ([7d3e485](https://github.com/n0-computer/iroh/commit/7d3e4857ee134a259d7b668560f6303dea1def16))
- *(iroh-dns)* Document how to use iroh on Android and run tests in Android emulator ([#4183](https://github.com/n0-computer/iroh/issues/4183)) - ([54e4a29](https://github.com/n0-computer/iroh/commit/54e4a291d26f9e3d1e340927294a3c895af55ffe))
- Protect against division by zero in process_datagram ([#4178](https://github.com/n0-computer/iroh/issues/4178)) - ([db1b335](https://github.com/n0-computer/iroh/commit/db1b3351469291020efb892049eb30479117b7cc))

### 🚜 Refactor

- *(iroh)* [**breaking**] Replace ConnectionInfo with WeakConnectionHandle ([#4189](https://github.com/n0-computer/iroh/issues/4189)) - ([9bfc8da](https://github.com/n0-computer/iroh/commit/9bfc8da3ca04cc19ce87670da0f7c49d40fce593))
- *(iroh)* [**breaking**] Make `Source` private and trim its variants ([#4227](https://github.com/n0-computer/iroh/issues/4227)) - ([927addf](https://github.com/n0-computer/iroh/commit/927addfdb3613804c66598e3c41c508aeec0c71d))
- *(iroh)* Express IPv6 ULA constants in hex ([#4225](https://github.com/n0-computer/iroh/issues/4225)) - ([cb8775c](https://github.com/n0-computer/iroh/commit/cb8775cbf6b6ad644ec8e9d449b135fcdbb46e1b))
- *(iroh)* Adapt for noq::Closed return type of Connection::closed ([#4229](https://github.com/n0-computer/iroh/issues/4229)) - ([217ec7c](https://github.com/n0-computer/iroh/commit/217ec7cc3b83f1b3d8de3f1cc3e0e8ec5e0ea824))
- *(iroh)* [**breaking**] Remove portmapper metrics from public API ([#4235](https://github.com/n0-computer/iroh/issues/4235)) - ([7955bea](https://github.com/n0-computer/iroh/commit/7955bea420a13ce2bf2c2f402deb6a701bacd46d))
- *(iroh)* Apply path status for path selection ([#4233](https://github.com/n0-computer/iroh/issues/4233)) - ([63ed351](https://github.com/n0-computer/iroh/commit/63ed3517066c74d52bd64d9ae9a02add22a016a5))
- *(iroh)* [**breaking**] Improve feature-gating for `unstable-custom-transports` ([#4228](https://github.com/n0-computer/iroh/issues/4228)) - ([f246242](https://github.com/n0-computer/iroh/commit/f246242ff1e6cc8cb865bfb5b8389b6f1ff0158f))
- *(iroh)* [**breaking**] Redesign path observation API ([#4188](https://github.com/n0-computer/iroh/issues/4188)) - ([3e82de5](https://github.com/n0-computer/iroh/commit/3e82de5088391fb00c7b645912861ebfc611ae34))
- *(iroh-dns-server)* [**breaking**] Reduce public API surface, improve docs, cleanup visibilities ([#4160](https://github.com/n0-computer/iroh/issues/4160)) - ([4ed44b7](https://github.com/n0-computer/iroh/commit/4ed44b7e7c9f0f0d0c420df99227dcc6e4d56850))
- *(iroh-relay)* [**breaking**] Do not depend on `tokio-rustls-acme` in public API ([#4166](https://github.com/n0-computer/iroh/issues/4166)) - ([5a984c6](https://github.com/n0-computer/iroh/commit/5a984c6ab4476c9c17ba1bd4d680b10b506e600d))
- *(iroh-relay)* Make MaybeTlsStream public again ([#4193](https://github.com/n0-computer/iroh/issues/4193)) - ([89ad5d8](https://github.com/n0-computer/iroh/commit/89ad5d89a22122ebc53d2166654d00062ee75b98))
- *(iroh-relay)* [**breaking**] Make `AccessConfig` non-exhaustive ([#4190](https://github.com/n0-computer/iroh/issues/4190)) - ([d636e54](https://github.com/n0-computer/iroh/commit/d636e54755622723e76ab461796cc7093a081b38))
- Prefer release assert for locations where a bounds check follows ([#4214](https://github.com/n0-computer/iroh/issues/4214)) - ([eb588ec](https://github.com/n0-computer/iroh/commit/eb588eccc876bc5b9dba5750d0bd0cc7b6261393))
- Prefer loop over zip ([#4215](https://github.com/n0-computer/iroh/issues/4215)) - ([c953d9b](https://github.com/n0-computer/iroh/commit/c953d9b3982aa08f517673ad7b717823cf248b13))
- [**breaking**] Mark more items as non-exhaustive ([#4226](https://github.com/n0-computer/iroh/issues/4226)) - ([eebb60f](https://github.com/n0-computer/iroh/commit/eebb60fef928d822a822adecdea092f2eaa00053))
- Remove obsolete fn transport_bias from endpoint builder. ([#4234](https://github.com/n0-computer/iroh/issues/4234)) - ([dd418df](https://github.com/n0-computer/iroh/commit/dd418df0920b6bf154869f63714453a7a23e3092))

### 📚 Documentation

- Add post quantum key exchange examples ([#4196](https://github.com/n0-computer/iroh/issues/4196)) - ([872d8ee](https://github.com/n0-computer/iroh/commit/872d8ee931f16708f0e8e32a80c9eaaf4127037f))

### 🧪 Testing

- *(iroh-relay)* Integration tests for embedding the relay ([#4206](https://github.com/n0-computer/iroh/issues/4206)) - ([88c9eed](https://github.com/n0-computer/iroh/commit/88c9eedd0fe08690e0d4baf9cbbab02d30b98a78))

### ⚙️ Miscellaneous Tasks

- *(ci)* Fix sccache for netsim ([#4176](https://github.com/n0-computer/iroh/issues/4176)) - ([4f22f1a](https://github.com/n0-computer/iroh/commit/4f22f1a53524a8239eba3d20c8d2d3d8a07da730))
- *(ci)* Fix musl/gnu build setup ([#4184](https://github.com/n0-computer/iroh/issues/4184)) - ([e95ac06](https://github.com/n0-computer/iroh/commit/e95ac068a3ffbcce18623ece739f4e7d952285b8))
- *(ci)* Make sccache fail gracefully ([#4208](https://github.com/n0-computer/iroh/issues/4208)) - ([a187130](https://github.com/n0-computer/iroh/commit/a1871300fc563202f38efe6d7ea85864d83c239f))
- *(ci)* Enforce external type allow-list in public API ([#4204](https://github.com/n0-computer/iroh/issues/4204)) - ([3e0c25f](https://github.com/n0-computer/iroh/commit/3e0c25f252e89a563a1d97f0f35b915b7c360010))
- *(ci)* Fix docker releases and musl linking ([#4230](https://github.com/n0-computer/iroh/issues/4230)) - ([5f578da](https://github.com/n0-computer/iroh/commit/5f578daac1f3c0a6149b4a83732aada7aecebc32))
- Fixup relative deps - ([1d0ff85](https://github.com/n0-computer/iroh/commit/1d0ff852aad08bc4157988c040df7793ffef4f26))

### Deps

- Pin pkcs8 and der ([#4197](https://github.com/n0-computer/iroh/issues/4197)) - ([36c5c6d](https://github.com/n0-computer/iroh/commit/36c5c6d1b7d96cbbb1373b1ee840d87062a19260))
...
- *(iroh)* Avoid allocations in `AddrFilter` ([#4018](https://github.com/n0-computer/iroh/issues/4018)) - ([d26cbd2](https://github.com/n0-computer/iroh/commit/d26cbd2fa09959b4a0264afb0d3661d553b5cb39))
- *(iroh)* Pluggable crypto backends ([#3992](https://github.com/n0-computer/iroh/issues/3992)) - ([387c2e4](https://github.com/n0-computer/iroh/commit/387c2e4fcb41ab24fc922003492ed232fb45aa4e))
- *(iroh)* Add ability to configure external addrs ([#4098](https://github.com/n0-computer/iroh/issues/4098)) - ([372aab9](https://github.com/n0-computer/iroh/commit/372aab94e24e0951d015a80ceb0fa5bd62ea9228))
- *(iroh)* Do not advertise deprecated IPv6 addrs ([#4106](https://github.com/n0-computer/iroh/issues/4106)) - ([b2b1d46](https://github.com/n0-computer/iroh/commit/b2b1d4615917733e990770831e02bb755af98839))
- *(iroh-relay)* Expose more metrics on the relay server ([#4085](https://github.com/n0-computer/iroh/issues/4085)) - ([ee844a6](https://github.com/n0-computer/iroh/commit/ee844a66b03db1d14b9a883136d38311fb6f4661))
- Expose the new fn decrypt on noq. ([#4002](https://github.com/n0-computer/iroh/issues/4002)) - ([197d8db](https://github.com/n0-computer/iroh/commit/197d8db094cc6ee24a6b9676241add00838f22be))
- Update noq and net-tools to latest ([#4088](https://github.com/n0-computer/iroh/issues/4088)) - ([159a5cf](https://github.com/n0-computer/iroh/commit/159a5cf29c95b9f9d9aabe12eac101a14fc12994))
- Rate limiting in router ([#3951](https://github.com/n0-computer/iroh/issues/3951)) - ([ea7a634](https://github.com/n0-computer/iroh/commit/ea7a634fad49c40bae47eb1bad98e9284e500b4a))
- Update relay protocol to iroh-relay-v2, add new Health frame, test protocol update mechanism ([#3955](https://github.com/n0-computer/iroh/issues/3955)) - ([0a22d76](https://github.com/n0-computer/iroh/commit/0a22d769052d491015d14cdc4d544a1144981f5d))
- Update to noq@0.18 ([#4121](https://github.com/n0-computer/iroh/issues/4121)) - ([72e4538](https://github.com/n0-computer/iroh/commit/72e4538332d85fcc91040094fbadf0532fef7426))
- Vendor pkarr implementation ([#4026](https://github.com/n0-computer/iroh/issues/4026)) - ([3ab6222](https://github.com/n0-computer/iroh/commit/3ab6222bc27931d750329563faa673bd1363d721))

### 🐛 Bug Fixes

- *(ci)* Install cmake and nasm for aws-lc-sys on Windows ([#4032](https://github.com/n0-computer/iroh/issues/4032)) - ([405de1d](https://github.com/n0-computer/iroh/commit/405de1de8df97701d472e6eb9fa467d68b249b4a))
- *(iroh)* [**breaking**] Faster relay health check after network change ([#4041](https://github.com/n0-computer/iroh/issues/4041)) - ([b11b0eb](https://github.com/n0-computer/iroh/commit/b11b0eb670d3f4967098699b089b1d2dc67389b9))
- *(iroh)* `Endpoint::online` should only return once connected to a relay ([#4115](https://github.com/n0-computer/iroh/issues/4115)) - ([3424c6d](https://github.com/n0-computer/iroh/commit/3424c6daf825acc3760e782deebeb00c08277d70))
- *(iroh)* [**breaking**] Don't stop address lookup when one service errors ([#4126](https://github.com/n0-computer/iroh/issues/4126)) - ([321443d](https://github.com/n0-computer/iroh/commit/321443d01d9cf1d446d5ff519b459a1dc224a93b))
- *(iroh)* Don't falsely report home relay as connected on change ([#4136](https://github.com/n0-computer/iroh/issues/4136)) - ([1b04d34](https://github.com/n0-computer/iroh/commit/1b04d345a3227ed328444b8b647ffa75cf944690))
- *(iroh-relay)* Send EndpointGone message to the right peers ([#4079](https://github.com/n0-computer/iroh/issues/4079)) - ([6be4b3c](https://github.com/n0-computer/iroh/commit/6be4b3cb8b32be0dc73e9bc2cefdbe422b8e8f2c))
- *(iroh-relay)* Treat frames not allowed in a protocol version as error ([#4127](https://github.com/n0-computer/iroh/issues/4127)) - ([1c92a39](https://github.com/n0-computer/iroh/commit/1c92a395bdb9b990d4230797fa3436f5e9005ead))
- Improve holepunching after network changes ([#3928](https://github.com/n0-computer/iroh/issues/3928)) - ([cc21f51](https://github.com/n0-computer/iroh/commit/cc21f51279b7fc091f6473c7993119b0c10319d7))
- Poll for default route with exponential backoff after network change ([#4039](https://github.com/n0-computer/iroh/issues/4039)) - ([dc01a77](https://github.com/n0-computer/iroh/commit/dc01a7703c4a7cef75df65e53a98fb261c593b85))
- Modify test_ip_wins_over_custom so it is a noop if no ip transport is… ([#4048](https://github.com/n0-computer/iroh/issues/4048)) - ([b141e02](https://github.com/n0-computer/iroh/commit/b141e02650310366847de6cdd0283a2620bfbb96))
- Increase path idle timeouts and configure relay paths ([#4038](https://github.com/n0-computer/iroh/issues/4038)) - ([eba6afc](https://github.com/n0-computer/iroh/commit/eba6afcba573403475dbb1062612a3eb1aee56a3))
- Handle wine properly ([#3902](https://github.com/n0-computer/iroh/issues/3902)) - ([8bf7002](https://github.com/n0-computer/iroh/commit/8bf7002e0e4ed9da83b6fc873a4182e249c366a3))
- Set default crypto provider for iroh-relay binary ([#4087](https://github.com/n0-computer/iroh/issues/4087)) - ([2433645](https://github.com/n0-computer/iroh/commit/2433645f2a726853fb12221b8f79f12819f0f25f))

### 🚜 Refactor

- *(iroh)* [**breaking**] Improve address lookup registry ([#4130](https://github.com/n0-computer/iroh/issues/4130)) - ([481c870](https://github.com/n0-computer/iroh/commit/481c8703c1fc751a7641fa421829b1b9e3c914c5))
- *(iroh, iroh-relay)* [**breaking**] Mark public types as non_exhaustive ([#4107](https://github.com/n0-computer/iroh/issues/4107)) - ([86d3ac6](https://github.com/n0-computer/iroh/commit/86d3ac607688b79d85f6f81383dc350499bf4aa3))
- *(iroh-base)* [**breaking**] Don't expose third-party error types in iroh-base ([#4073](https://github.com/n0-computer/iroh/issues/4073)) - ([d803dfe](https://github.com/n0-computer/iroh/commit/d803dfecbb6796a814b98ba6e8662d868d45e16e))
- *(iroh-base)* [**breaking**] Rename `CustomAddr::as_vec`  to `CustomAddr::to_vec` and improve docs ([#4074](https://github.com/n0-computer/iroh/issues/4074)) - ([3077f17](https://github.com/n0-computer/iroh/commit/3077f172a1d6f762f9f2a8269a301887c74a5155))
- *(iroh-base)* [**breaking**] Change `SecretKey::generate` to not take an `Rng` arg ([#4075](https://github.com/n0-computer/iroh/issues/4075)) - ([36781ad](https://github.com/n0-computer/iroh/commit/36781ad4240f5ba7c803747c4927cf2a5d895526))
- *(iroh-relay)* [**breaking**] Proper timeouts on relay connections ([#4083](https://github.com/n0-computer/iroh/issues/4083)) - ([79bb0e4](https://github.com/n0-computer/iroh/commit/79bb0e48e9a51d3dbf845859f4cdf9c1a1c8e175))
- Use latest noq api ([#4057](https://github.com/n0-computer/iroh/issues/4057)) - ([8af8370](https://github.com/n0-computer/iroh/commit/8af8370b567d9e9a89aaf25929b327a6a5b96de1))
- Remove needless alloc in relay server ([#4084](https://github.com/n0-computer/iroh/issues/4084)) - ([40b50a1](https://github.com/n0-computer/iroh/commit/40b50a11d9963eb156750e2dca10298ffa085e1a))
- Move to_z32/from_z32 into iroh-base and remove EndpointIdExt trait ([#4133](https://github.com/n0-computer/iroh/issues/4133)) - ([382bf36](https://github.com/n0-computer/iroh/commit/382bf3620e614b267541a56ec0a32784b2e838bc))

### 🧪 Testing

- *(iroh)* Add patchbay test matrix for switching uplinks ([#4095](https://github.com/n0-computer/iroh/issues/4095)) - ([d72f1cb](https://github.com/n0-computer/iroh/commit/d72f1cb87a3234493f18db2fb78b96c0bcf002e3))
- *(iroh)* Add more patchbay tests and improve existing tests ([#4118](https://github.com/n0-computer/iroh/issues/4118)) - ([f5ec24a](https://github.com/n0-computer/iroh/commit/f5ec24a636ea6cb67f567293d1ce55df2a674090))
- *(iroh)* Improve patchbay NAT matrix ([#4135](https://github.com/n0-computer/iroh/issues/4135)) - ([2ad657a](https://github.com/n0-computer/iroh/commit/2ad657ad221af7c51f31f605e8ed314fecb10ed0))
- Fix ip_wins_over_custom flakiness ([#4047](https://github.com/n0-computer/iroh/issues/4047)) - ([174b58b](https://github.com/n0-computer/iroh/commit/174b58ba2880ac2ae17d19ddae318ffdacd2ead4))
- Add patchbay tests ([#3986](https://github.com/n0-computer/iroh/issues/3986)) - ([2ab1240](https://github.com/n0-computer/iroh/commit/2ab12409b1c5f0d75d4d94d82b76abb53169c362))
- Improve patchbay test setup ([#4078](https://github.com/n0-computer/iroh/issues/4078)) - ([9b01751](https://github.com/n0-computer/iroh/commit/9b01751b6dfc89d3080cf46d9d596242a1816dfd))
- Minor patchbay test improvements ([#4091](https://github.com/n0-computer/iroh/issues/4091)) - ([0cc2441](https://github.com/n0-computer/iroh/commit/0cc244190be10547df184e225d4af0efa3a45e04))

### ⚙️ Miscellaneous Tasks

- *(ci)* Move more CI jobs to self hosted runners ([#4072](https://github.com/n0-computer/iroh/issues/4072)) - ([54442c3](https://github.com/n0-computer/iroh/commit/54442c3013070895e9096c446d4885a0740ac30a))
- *(iroh)* Update hickory to 0.26.0-beta.4 and use exact-version deps for prereleased crates ([#4117](https://github.com/n0-computer/iroh/issues/4117)) - ([f829593](https://github.com/n0-computer/iroh/commit/f8295934bda4b73d7ae3397ee6f4ecdf883574c0))
- *(iroh-bench)* Allow configuring the number of worker threads for each endpoint in iroh-bench ([#4063](https://github.com/n0-computer/iroh/issues/4063)) - ([065b448](https://github.com/n0-computer/iroh/commit/065b448700265ca094445934d7466a69b1d3d569))
- Update to netwatch@0.16 and portmapper@0.16 ([#4128](https://github.com/n0-computer/iroh/issues/4128)) - ([24efedf](https://github.com/n0-computer/iroh/commit/24efedf65e43775edf4b4db3a4b0c6c3e835d04f))
- Fix changelog generation - ([08c6454](https://github.com/n0-computer/iroh/commit/08c6454ac6ef3188ca87667470283f0aa4762e92))

### Deps

- *(iroh)* Update patchbay to 0.5 ([#4097](https://github.com/n0-computer/iroh/issues/4097)) - ([811a062](https://github.com/n0-computer/iroh/commit/811a0627fe8aa90d8c1549fc0cdf6def0e77d47e))
- Bump noq and net-tools ([#4113](https://github.com/n0-computer/iroh/issues/4113)) - ([184e378](https://github.com/n0-computer/iroh/commit/184e3787952a0ffc23f1a1dfa1c9fbd2dc639b9b))

### Examples

- *(iroh)* Allow to configure the receive window in the transfer example ([#4082](https://github.com/n0-computer/iroh/issues/4082)) - ([c865251](https://github.com/n0-computer/iroh/commit/c865251ffdef6a03e6f5e38063ff11ae3bc9b3c9))

## [0.97.0](https://github.com/n0-computer/iroh/compare/v0.96.1..0.97.0) - 2026-03-16

### ⛰️  Features

- *(iroh)* [**breaking**] Dropping the endpoint ungracefully should log and error, but still clean up resources immediately ([#3879](https://github.com/n0-computer/iroh/issues/3879)) - ([9cf417a](https://github.com/n0-computer/iroh/commit/9cf417aa9700e2dc77fc56add8bf54cdb7dadc1b))
- *(iroh)* [**breaking**] Retain stats for closed and abandoned paths in the path watcher ([#3899](https://github.com/n0-computer/iroh/issues/3899)) - ([b11e707](https://github.com/n0-computer/iroh/commit/b11e707cc88403a54266e18bb6d359f4fe7715e8))
- *(iroh)* More precise information about incoming connections ([#3949](https://github.com/n0-computer/iroh/issues/3949)) - ([abc349c](https://github.com/n0-computer/iroh/commit/abc349c88f5588056eecc0ac7bb425d52dcaf14a))
- *(iroh)* [**breaking**] Add address filtering and reordering for Address Lookup Services ([#3960](https://github.com/n0-computer/iroh/issues/3960)) - ([d33a32f](https://github.com/n0-computer/iroh/commit/d33a32f986ae6fb6c927b6da782d8bac7f54cbdc))
- *(iroh)* Proper span for endpoints ([#3988](https://github.com/n0-computer/iroh/issues/3988)) - ([e23f2f3](https://github.com/n0-computer/iroh/commit/e23f2f38b50326650cf87757b92550a0d7d2324b))
- *(iroh)* Allow propagation of addr filters through the endpoint ([#4010](https://github.com/n0-computer/iroh/issues/4010)) - ([5df183d](https://github.com/n0-computer/iroh/commit/5df183db535b55918165e7a8eec016238b3bb0ba))
- *(iroh)* Add tracing events for connections ([#4021](https://github.com/n0-computer/iroh/issues/4021)) - ([f226881](https://github.com/n0-computer/iroh/commit/f226881f6f61f179c70b118acb0fcd20ec1b80a9))
- *(iroh)* [**breaking**] Cleanup preset API ([#4014](https://github.com/n0-computer/iroh/issues/4014)) - ([759f14e](https://github.com/n0-computer/iroh/commit/759f14eb0e09080777c552b1b3fba55d13d0eb70))
- *(iroh-relay)* Embeddable relay server ([#3832](https://github.com/n0-computer/iroh/issues/3832)) - ([fe7f04f](https://github.com/n0-computer/iroh/commit/fe7f04f63e7fa61b5a28b0abda8c46d24f43eec0))
- *(netsim)* Filter tests ([#3946](https://github.com/n0-computer/iroh/issues/3946)) - ([1729243](https://github.com/n0-computer/iroh/commit/1729243d264ff6fd2ddbde6fa15c81f3e89550f3))
- Allow to customize TLS trust roots ([#3973](https://github.com/n0-computer/iroh/issues/3973)) - ([ba4ee62](https://github.com/n0-computer/iroh/commit/ba4ee62972f584a8b100f7091bcc3ca449669b42))
- Implement custom transports ([#3845](https://github.com/n0-computer/iroh/issues/3845)) - ([d434c85](https://github.com/n0-computer/iroh/commit/d434c85e1bd2221b73f69c3326214812a9d08d83))
- [**breaking**] Switch noq ([#4005](https://github.com/n0-computer/iroh/issues/4005)) - ([b32c927](https://github.com/n0-computer/iroh/commit/b32c9277749b163a82ed6253a65bb1439216b08c))

### 🐛 Bug Fixes

- *(docs)* Just a typo in the documentation for mdns discovery ([#3929](https://github.com/n0-computer/iroh/issues/3929)) - ([cf6acb5](https://github.com/n0-computer/iroh/commit/cf6acb5bbd113c1aa277c4e418668275d70f053a))
- *(example)* Always close the endpoint ([#4007](https://github.com/n0-computer/iroh/issues/4007)) - ([afc1faa](https://github.com/n0-computer/iroh/commit/afc1faa5cd868a3eff50d6ff93d7bd22f6765fab))
- *(iroh)* Disable QAD if no IP transports are configured ([#3926](https://github.com/n0-computer/iroh/issues/3926)) - ([aa14381](https://github.com/n0-computer/iroh/commit/aa143819fffe8efb93dcb787cca872bec295dd7f))
- *(iroh)* [**breaking**] Reexport full dns module from iroh-relay ([#3916](https://github.com/n0-computer/iroh/issues/3916)) - ([523c93c](https://github.com/n0-computer/iroh/commit/523c93c1baef209690785f0348cbb839c37f42e6))
- *(iroh)* Don't depend on the unused `relays` ff of pkarr ([#4004](https://github.com/n0-computer/iroh/issues/4004)) - ([2494255](https://github.com/n0-computer/iroh/commit/2494255cc758caa9f8e6f0c6ed1c485cf7445e21))
- *(iroh)* [**breaking**] Don't publish IP addresses from `PkarrPublisher` by default ([#4012](https://github.com/n0-computer/iroh/issues/4012)) - ([b3da940](https://github.com/n0-computer/iroh/commit/b3da9402f48c876f0dd60c9014f7c3443de23b6b))
- *(iroh-relay)* Turn off nagle for relayed streams in iroh-relay servers ([#3995](https://github.com/n0-computer/iroh/issues/3995)) - ([82e0695](https://github.com/n0-computer/iroh/commit/82e06959335f1ddbb6c53487395294c6388563f2))
- *(tests)* Give test longer to not be flaky ([#3939](https://github.com/n0-computer/iroh/issues/3939)) - ([1324c66](https://github.com/n0-computer/iroh/commit/1324c66251d50f987d592d74281b5d40a457ab73))
- Configure git identity in cleanup workflow  - ([dbe5112](https://github.com/n0-computer/iroh/commit/dbe5112cb821ac0dbfac37c40c4c585f09037050))
- Increase DNS timeout and address lookup stagger intervals ([#4008](https://github.com/n0-computer/iroh/issues/4008)) - ([993b018](https://github.com/n0-computer/iroh/commit/993b018eb3e5344fff03ee73d74b84134ab90650))

### 🚜 Refactor

- *(iroh)* Avoid rustls feature flag use in `resolver.rs` ([#3985](https://github.com/n0-computer/iroh/issues/3985)) - ([dd381a1](https://github.com/n0-computer/iroh/commit/dd381a1b2b03bd58816f2949398f9ac6ec526b44))
- *(iroh)* Use combinator approach for address filtering ([#3987](https://github.com/n0-computer/iroh/issues/3987)) - ([a289f63](https://github.com/n0-computer/iroh/commit/a289f630d4c3b5c8921a7dc23ab96e25c386e670))
- *(iroh, iroh-relay)* [**breaking**] Relay should not kill old connections when same endpoint id connects ([#3921](https://github.com/n0-computer/iroh/issues/3921)) - ([1b4ee2a](https://github.com/n0-computer/iroh/commit/1b4ee2a9798a7d78eaef87841e1f85818807fdc0))
- *(transfer example)* Remove `SelectedPath::Mixed` as an impossible state ([#3895](https://github.com/n0-computer/iroh/issues/3895)) - ([9cc8602](https://github.com/n0-computer/iroh/commit/9cc86027ed6d619161a5fe5985c3bb2bd08030f1))
- Simplify path selection  - ([df6c396](https://github.com/n0-computer/iroh/commit/df6c396410d15b98d8a04b33e6167695984c1842))
- Update quinn and simplify path handling in `RemoteStateActor` ([#3967](https://github.com/n0-computer/iroh/issues/3967)) - ([1ffb560](https://github.com/n0-computer/iroh/commit/1ffb5602087b1ace3faa97c49b48311a2fc6e81a))
- Add doc comments, move code around, rename ([#3977](https://github.com/n0-computer/iroh/issues/3977)) - ([1c5bd5b](https://github.com/n0-computer/iroh/commit/1c5bd5bf0a03c7919a99da08f486b21ec754e00f))
- Remove special fast path for hickory resolver ([#4022](https://github.com/n0-computer/iroh/issues/4022)) - ([7fc9fb9](https://github.com/n0-computer/iroh/commit/7fc9fb93e2d30badb95a87e2406f225ea73b8b48))

### 📚 Documentation

- Fix typo in documentation comment for generate function ([#4001](https://github.com/n0-computer/iroh/issues/4001)) - ([766097b](https://github.com/n0-computer/iroh/commit/766097b0c28137a8ade31ba9a60d1c7e16a2893b))

### ⚙️ Miscellaneous Tasks

- *(ci)* Add custom RUST_LOG support for netsim ([#3942](https://github.com/n0-computer/iroh/issues/3942)) - ([d240360](https://github.com/n0-computer/iroh/commit/d240360725b75425aab6a37fb3ee61f50812e533))
- *(ci)* Colocate sims into iroh repo ([#3957](https://github.com/n0-computer/iroh/issues/3957)) - ([403238a](https://github.com/n0-computer/iroh/commit/403238af1a3b37714bced11ca5f592e67be4993d))
- *(ci)* Add text summary for discord notification ([#3962](https://github.com/n0-computer/iroh/issues/3962)) - ([6650c78](https://github.com/n0-computer/iroh/commit/6650c780e7e15ab8ee73c0e6ed23398e5f721ee1))
- *(iroh)* Add `--logs`  and `--mode ping` features to transfer example ([#3893](https://github.com/n0-computer/iroh/issues/3893)) - ([08b0b8a](https://github.com/n0-computer/iroh/commit/08b0b8a38197687eb6e99b71a9eb1ee803a00bd1))
- *(iroh)* Update noq commit, stop exposing `AeadKey` ([#4003](https://github.com/n0-computer/iroh/issues/4003)) - ([bf07082](https://github.com/n0-computer/iroh/commit/bf07082556ef85f542f6c490bcb8a407fb3d84ce))
- *(readme)* Link to noq instead of Quinn ([#3989](https://github.com/n0-computer/iroh/issues/3989)) - ([4033b3c](https://github.com/n0-computer/iroh/commit/4033b3c54578d6cef2746c2b8860468758be1b4e))
- Update to quinn main ([#3938](https://github.com/n0-computer/iroh/issues/3938)) - ([3a45cd0](https://github.com/n0-computer/iroh/commit/3a45cd0f1bd17b3b0aff81a263b6686b0eb5b837))
- Remove process and signal tokio features ([#3993](https://github.com/n0-computer/iroh/issues/3993)) - ([086c6e8](https://github.com/n0-computer/iroh/commit/086c6e8a5e8b1691052e8753956ce586a64be800))
- Update deps ([#4006](https://github.com/n0-computer/iroh/issues/4006)) - ([df0777a](https://github.com/n0-computer/iroh/commit/df0777a21ab2c19be86e4b7f0f60331f94a95a3b))
- Remove netdev from the direct dependencies ([#4019](https://github.com/n0-computer/iroh/issues/4019)) - ([76609fd](https://github.com/n0-computer/iroh/commit/76609fd62a9a54f8c7599810e0a2c1aa638f3884))
- Update changelog generation command - ([29c8c85](https://github.com/n0-computer/iroh/commit/29c8c856be7c2ec3fc92130909daccea0efa5fda))

### Deps

- Bump wasm-bindgen-test ([#3966](https://github.com/n0-computer/iroh/issues/3966)) - ([f628359](https://github.com/n0-computer/iroh/commit/f62835999095d2498be968d476bb0049a9c2cc2e))
- Upgrade away from yanked crate ([#3982](https://github.com/n0-computer/iroh/issues/3982)) - ([1e4a738](https://github.com/n0-computer/iroh/commit/1e4a738b81bbf3025468363ddbcefaa54e4116a6))
- Prefer portable_atomic over native AtomicU64 ([#3994](https://github.com/n0-computer/iroh/issues/3994)) - ([ae4877e](https://github.com/n0-computer/iroh/commit/ae4877e0134293fb640ae80a5855126f33990249))
- Feature gate portmapper, and allow disabling portmapper by default. ([#4011](https://github.com/n0-computer/iroh/issues/4011)) - ([647f28e](https://github.com/n0-computer/iroh/commit/647f28ed11d19c46b60e89db2e70ca80b48948e4))

### Examples

- *(iroh)* Improve transfer example with qlog flag and timestamp for JSON output ([#3964](https://github.com/n0-computer/iroh/issues/3964)) - ([5d9ac04](https://github.com/n0-computer/iroh/commit/5d9ac048dffa49155dd26ade5021f347b3ec2192))

## [0.96.1](https://github.com/n0-computer/iroh/compare/v0.96.0..v0.96.1) - 2026-02-06
...
- Release - ([82650d1](https://github.com/n0-computer/iroh/commit/82650d1d1ffa59de36afa937471b484d358fbc7f))
...
## [0.95.1](https://github.com/n0-computer/iroh/compare/v0.95.0..v0.95.1) - 2025-11-05

### 🐛 Bug Fixes

- Removal of path selection missed a cfg attribute - ([8f1cb97](https://github.com/n0-computer/iroh/commit/8f1cb977358e29142be557443bfa2192d2732085))
...
- Release - ([9f00137](https://github.com/n0-computer/iroh/commit/9f00137c396f5790f24de11d5c1d7b9d42ad234e))
...
- Fix typos - ([a5ca365](https://github.com/n0-computer/iroh/commit/a5ca3652272e8bb9ee4b516f16c8ffc8bcdd54f9))
...
- Update git deps - ([b4114fa](https://github.com/n0-computer/iroh/commit/b4114fa6f6381f882ef515a566e6de3b0847c6d5))
...
- Use quinn multipath - ([c17a870](https://github.com/n0-computer/iroh/commit/c17a870e1c8396ae22557040288e5f1feaf65e83))
